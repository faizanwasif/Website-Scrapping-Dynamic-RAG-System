...
1. **DynamicWebsiteRAG**: Core component for handling JavaScript-rendered content using Playwright
2. **Crawl4AIRagAdapter**: Integration with Crawl4AI for efficient web scraping
3. **LangGraphRAG**: Orchestration layer for complex workflows using the LangGraph framework
4. **RAG2System**: High-level interface implementing RAG 2.0 concepts
...
```javascript
const { RAG2System } = require('./rag2-system');
...
1. RAG 2.0: Supercharging LLMs with Real-Time Web Data and LangGraph
